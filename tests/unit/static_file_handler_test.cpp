...
void testPrepareRejectsRangesAndHonorsIfModifiedSince()
{
    ...
    CHECK(handler.prepare(ranged, &plan));
    CHECK(plan.status == HttpResponse::k416RangeNotSatisfiable);
...
int main()
{
    ...
    testPrepareRejectsRangesAndHonorsIfModifiedSince();
