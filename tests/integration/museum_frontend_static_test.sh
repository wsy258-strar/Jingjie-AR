...
grep -Fq 'id="scene-dissolve"' "$index"
grep -Fq 'id="filing-records"' "$index"
grep -Fq 'id="icp-filing-link"' "$index"
...
grep -Fq 'width: 100px;' "$css"
grep -Fq 'height: 100px;' "$css"
grep -Fq 'font-size: 16px;' "$css"
grep -Fq 'justify-content: center;' "$css"
grep -Fq 'flex-basis: 66px;' "$css"
grep -Fq 'width: 66px;' "$css"
grep -Fq 'height: 66px;' "$css"
grep -Fq 'font-size: 12px;' "$css"
grep -Fq 'justify-content: flex-start;' "$css"
